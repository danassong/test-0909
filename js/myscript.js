(function($){
    ...
    $('section').on('mousemove', function(e){
        ...
        //     right: posX/30 + 10 + 'px',
        //     bottom: posY/30 + 10 + 'px'
        // })
        // $('section').eq(1).find('img:nth-of-type(2)').css({
        //     right: posX/30 + 10 + 'px',
        //     bottom: posY/30 + 10 + 'px'
        // })
        // $('section').eq(2).find('img:nth-of-type(3)').css({
        //     right: posX/30 + 10 + 'px',
        //     bottom: posY/30 + 10 + 'px'
        // })
        // $('section').eq(3).find('img:nth-of-type(4)').css({
        //     right: posX/20 + 10 + 'px',
        //     bottom: posY/30 + 10 + 'px'
        // })
        ...
        $("section:nth-child(4) img:nth-of-type(2)").css({
            right:70+(posX/20), bottom:200+(posY/20) })
    })
